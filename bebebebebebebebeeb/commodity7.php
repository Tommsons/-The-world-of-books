    ...
    <div class="products">
      ...
      <div class="photo_name_book">
        <div class="photo_book">
          <img src="img/book77.png" class="img_book" style="margin-right: 80px;margin-left: 80px;">
        </div>
        <div class="name_book">
          <h1>Убить большого Соню</h1>
      ...
      <div class="annotation">
        <h1>Аннотация:</h1>
        <p class="annotation_text">Эта книга — настоящий электрошокер. Дерзкая и невероятно искренняя, она заставляет
          проснуться, оторвать пятую точку от
          дивана и начать действовать. Ее автор, в прошлом бедствующий фрилансер, однажды решила, что хочет стать
          богатой и
          знаменитой. Она испытала на себе все известные системы личностной трансформации, выбрала 25 подходов, которые
          дали
          результат, и превратила их в логичную систему полного преображения жизни. На сегодня книга разошлась более чем
          миллионным тиражом и была издана в 28 странах мира.
          Также выходит под названиями «НИ СЫ. Будь уверен в своих силах и не позволяй сомнениям мешать тебе двигаться
          вперед» и
          «Будь дерзким! Как перестать сомневаться в собственном величии и сделать жизнь грандиозной».</p>
      </div>
    </div>
    <footer class="footer">
