    ...
    <div class="products">
      ...
      <div class="photo_name_book">
        <div class="photo_book">
          <img src="img/book2.png" class="img_book">
        </div>
        <div class="name_book">
          <h1>The Essential Classics</h1>
          <p>
            Жанры: Фантастика, Комедия, Романтика, Драма, Ужасы;
          </p>
          <p>
            Рейтинг: 18+;
          </p>
      ...
      <div class="annotation">
        <h1>Аннотация:</h1>
        <p class="annotation_text">Сборник классических произведений</p>
      </div>
    </div>
    <footer class="footer">
