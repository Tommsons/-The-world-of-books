    ...
    <div class="products">
      ...
      <div class="photo_name_book">
        <div class="photo_book">
          <img src="img/book1111.png" class="img_book" style="margin-right: 80px;margin-left: 80px;">
        </div>
        <div class="name_book">
          <h1>Управление тревогой</h1>
      ...
      <div class="annotation">
        <h1>Аннотация:</h1>
        <p class="annotation_text">Психотерапевт Катлин Смит просто и доступно рассказывает о том, как и в чем
          проявляется тревожность и как влияет на нашу
          жизнь. Автор опирается на теорию Мюррея Боуэна и разъясняет ее основные положения на примерах из собственной
          практики,
          которые охватывают все сферы нашей жизни – от профессиональной до личной, в том числе и отношения с
          родителями. В каждой
          главе Катлин Смит дает практические рекомендации, позволяющие сформировать цельное и устойчивое «я» и
          избавиться от
          тревожности.

          Издание будет интересно всем, кто интересуется психологией и саморазвитием.</p>
      </div>
    </div>
    <footer class="footer">
