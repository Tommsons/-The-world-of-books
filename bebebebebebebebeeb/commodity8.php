    ...
    <div class="products">
      ...
      <div class="photo_name_book">
        <div class="photo_book">
          <img src="img/book88.png" class="img_book" style="margin-right: 80px;margin-left: 80px;">
        </div>
        <div class="name_book">
          <h1>Наши внутренние конфликты</h1>
          <p style="margin-right: 80px;">
            Жанры: Психология, Неврозы, Психоанализ, Психологические исследования;
          </p>
          <p>
            Рейтинг: 16+;
          </p>
      ...
      <div class="annotation">
        <h1>Аннотация:</h1>
        <p class="annotation_text">Данная книга завершает серию работ по теории невроза и дает первое в мировой практике
          систематическое изложение теории
          невроза — причин невротических конфликтов, их развития и лечения. Развитая К. Хорни конструктивная теория
          невроза до сих
          пор остается непревзойденной по широте и глубине объяснения невротических конфликтов. Она включает
          исчерпывающую
          классификацию невротических типов личности; основных невротических влечений и их связь с базисным конфликтом;
          содержит
          анализ всех основных способов защиты и методов подлинного разрешения невротических конфликтов.</p>
      </div>
    </div>
    <footer class="footer">
