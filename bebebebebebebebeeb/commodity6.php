    ...
    <div class="products">
      ...
      <div class="photo_name_book">
        <div class="photo_book">
          <img src="img/book66.png" class="img_book" style="margin-right: 80px;margin-left: 80px;">
        </div>
        <div class="name_book">
          <h1>Два капитана</h1>
          <p style="margin-right: 80px;">
            Жанры: Приключенческая литература, Роман;
          </p>
          <p>
            Рейтинг: 16+;
          </p>
        ...
        <div class="annotation">
          <h1>Аннотация:</h1>
          <p class="annotation_text">Роман Вениамина Каверина "Два капитана" - одно из культовых произведений советской
            приключенческой литературы. Эта
            необыкновенная история о любви, чести и мужестве не оставляет равнодушными уже несколько поколений
            читателей.
            Саня
            Григорьев всю жизнь посвятил тому, чтобы отыскать следы пропавшей экспедиции капитана Ивана Татаринова и
            восстановить
            доброе имя этого отважного путешественника и исследователя. В поисках истины ему пришлось принимать
            непростые,
            а порой и
            крайне тяжёлые решения. Юношеская мечта привела Саню в ряды лётчиков-полярников. Пройдя через множество
            суровых
            испытаний и потерь, капитан Григорьев сохраняет в себе душевную чуткость и человеческое достоинство, а его
            целеустремлённый характер помогает сдержать данную ещё в детстве клятву: "Бороться и искать, найти и не
            сдаваться".</p>
        </div>
      </div>
      <footer class="footer">
